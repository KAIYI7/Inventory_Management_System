...
<div class="records-page">
  <div class="records-container">
    ...
    <div class="records-grid">
      ...
      {{-- Orders --}}
      <div class="records-card">
        <h2><i class="fas fa-shopping-cart"></i> Orders (Received / Cancelled)</h2>
        <div class="table-responsive">
          <table class="table">
            <thead>
              <tr>
            ...
            <tbody>
              @forelse($orders as $o)
                @php
                  ...
                  $cls  = $o->status === 'received' ? 'text-green-600' : ($o->status === 'cancelled' ? 'text-red-600' : 'text-gray-700');
                @endphp
                <tr>
              ...
              @empty
                <tr><td colspan="5" class="text-center">No received or cancelled orders</td></tr>
              @endforelse
            </tbody>
          </table>
        </div>
